...
export function OrganizationGatewayTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          <Column field="target" width="150px" title="Org" columnMenu={ColumnMenu} />
          <Column field="budget" width="180px" title="Adapter Listener" columnMenu={ColumnMenu} />
          <Column field="budget" width="140px" title="Req/ Res" columnMenu={ColumnMenu} />
          <Column field="budget" width="140px" title="Tran Type" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="GATEWAY" columnMenu={ColumnMenu} />
        </Grid>
      </ExcelExport>
