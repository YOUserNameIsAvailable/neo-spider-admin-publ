...
export function CodeMappingManagementTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          groupable={false}
          size={"small"}>
          <Column field="budget" width="150px" title="Code group ID" columnMenu={ColumnMenu} />
          <Column field="full_name" width="200px" title="Code group name" columnMenu={ColumnMenu} />
          <Column field="target" width="150px" title="Standard code" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Standard code name" columnMenu={ColumnMenu} />
          <Column field="budget" width="250px" title="Org code" columnMenu={ColumnMenu} />
          <Column field="budget" width="100px" title="Org" columnMenu={ColumnMenu} />
        </Grid>
      </ExcelExport>
