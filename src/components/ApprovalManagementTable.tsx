          ...
          <Window
            ...
            <div className="flex flex-col">
              ...
              <TabStrip className="approval-tab" selected={selected} onSelect={handleSelect}>
                <TabStripTab title={<span className="p-[5px] font-bold text-[#656565]">요청된 결제내용</span>}>
                  <div className="flex flex-col border-[1px] border-[#dfe1e1]">
                    ...
                    <div className="flex h-[200px] w-full flex-row justify-between border-b-[1px] border-[#dfe1e1]">
                      <div className="flex h-full w-full flex-row items-center">
                        ...
                        <div className="shrink-1 flex flex-grow gap-4"></div>
                      </div>
                    </div>
                ...
                <TabStripTab title={<span className="p-[5px] font-bold text-[#656565]">결재 요청 항목리스트</span>}>
                  <div className="flex flex-col">
                    <div className="flex flex-col border-[1px] border-[#dfe1e1]">
                      <div className="flex h-[29px] flex-row justify-between border-b-[1px] border-[#dfe1e1]">
                      ...
                      <div className="flex h-[29px] flex-row justify-between border-b-[1px] border-[#dfe1e1]">
                        <div className="flex w-[80%] flex-row items-center">
                          ...
                          <Input className="my-[2px] ml-[2px] w-[85%] rounded-[2px] border-[1px] border-[#999999] py-[2px]" />
                          <span className="required">*</span>
                        </div>
                        <div className="flex w-[20%] flex-row">
                          <label className="flex h-full w-[75px] min-w-[75px] items-center bg-[#d1daec] p-[4px] text-[12px] text-black">
                                    ...
                                    return (
                                      <td {...props.tdProps} style={{ textAlign: "center" }}>
                                        <Button
                                          ...
                                          onClick={() => console.log("props: ", props.tdProps, props)}>
                                          다운로드
                                        </Button>
                                      </td>
                                    );
