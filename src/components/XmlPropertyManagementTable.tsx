...
export function XmlPropertyManagementTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          groupable={false}
          size={"small"}>
          <Column field="budget" width="200px" title="Property File" columnMenu={ColumnMenu} />
          <Column field="full_name" width="350px" title="Property desc" columnMenu={ColumnMenu} />
          <Column
            field="budget"
            width="150px"
          ...
          <Column
            field="budget"
            width="180px"
            headerCell={() => <div style={{ textAlign: "center" }}>Property Del</div>}
            cell={(props) => (
              <td style={{ textAlign: "center" }}>
                {" "}
                <Button size={"small"} className="px-4" themeColor={"primary"}>
