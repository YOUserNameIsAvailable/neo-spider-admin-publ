...
export function WasStatusMonitorTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          <Column field="budget" width="150px" title="Status" columnMenu={ColumnMenu} />
          <Column
            field="budget"
            width="200px"
            title="Socket
                        conn count"
          />
          <Column field="budget" width="180px" title="Recent update time" columnMenu={ColumnMenu} />
