...
export function BizGroupmanagementTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          groupable={false}
          size={"small"}>
          <Column field="budget" width="200px" title="Biz group ID" columnMenu={ColumnMenu} />
          <Column field="full_name" width="200px" title="Biz group name" columnMenu={ColumnMenu} />
          <Column field="target" width="200px" title="Main category ID" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Main category name" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Biz sub group ID" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Biz sub group name" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Description" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Site" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="DEPTH" columnMenu={ColumnMenu} />
        </Grid>
      </ExcelExport>
