...
export function ErrorHandlerExecutionTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          <Column field="full_name" width="300px" title="Error occur serial no" columnMenu={ColumnMenu} />
          <Column field="target" width="300px" title="Handler ID" columnMenu={ColumnMenu} />
          <Column field="budget" width="140px" title="Result contents" columnMenu={ColumnMenu} />
          <Column field="budget" width="130px" title="Result code" columnMenu={ColumnMenu} />
          <Column field="budget" width="180px" title="Error handling date" columnMenu={ColumnMenu} />
        </Grid>
      </ExcelExport>
