...
export function GatewayManagementTable() {
    ...
    <div>
      <ExcelExport>
        <Grid
          ...
          groupable={false}
          size={"small"}>
          <Column field="budget" width="180px" title="GATEWAY" columnMenu={ColumnMenu} />
          <Column field="full_name" width="300px" title="G/W desc" columnMenu={ColumnMenu} />
          <Column field="target" width="300px" title="Implemented app name" columnMenu={ColumnMenu} />
          <Column field="budget" width="200px" title="Adapter Listener" columnMenu={ColumnMenu} />
          <Column field="budget" width="140px" title="THREAD" columnMenu={ColumnMenu} />
          <Column
            field="budget"
            width="130px"
            title="Relation org"
