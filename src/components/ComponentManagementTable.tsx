...
import { ComponentManagementModal } from "./modal/ComponentManagementModal";
...
export function ComponentManagementTable() {
  ...
  const [showModal, setShowModal] = React.useState(false); // <11-2> Component management - Component info
    ...
    <>
      <div>
        ...
        <GridPDFExport margin="1cm">
          ...
          {showModal && <ComponentManagementModal setShowModal={setShowModal} />}
    </>
  );
}
