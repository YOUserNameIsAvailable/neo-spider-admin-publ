          ...
          <Window
            ...
            <div className="flex flex-col gap-[10px]">
                      ...
                      {v.type === "input2" ? (
                        <div className="flex h-[30px] w-full  border-[1px]" key={v.id}>
                          <div className="flex w-[50%] items-center">
                            ...
                            <input
                              className="ml-[2px] w-[100%] rounded-[2px] border-[1px] border-[1px] border-[#999999] py-[2px]"
                              disabled={v.disabled}
                            />
                        ...
                        <div className="flex h-[103px] w-full  border-[1px]" key={v.id}>
                          <div className="flex w-[100%] items-center">
                            <label className="flex h-full w-[150px] min-w-[150px] items-center bg-[#d1daec] p-1 text-[12px] text-black">
                              {v.id}
                            </label>
              ...
              <div className="flex flex-row-reverse">
                ...
                <button
                  style={{
                    background: "url(./images/btn_all_delete.png)",
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
