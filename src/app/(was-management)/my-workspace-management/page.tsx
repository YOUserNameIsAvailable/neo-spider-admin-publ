...
import { MyWorkspaceManagementSearchUserModal } from "../../../components/modal/MyWorkspaceManagementSearchUserModal";
import { MyWorkspaceManagementGroupManageModal } from "../../../components/modal/MyWorkspaceManagementGroupManageModal";
...
export default function Page() {
  ...
  return (
    <>
      ...
      {searchUser && <MyWorkspaceManagementSearchUserModal setSearchUser={setSearchUser} />}
      {groupManage && <MyWorkspaceManagementGroupManageModal setGroupManage={setGroupManage} />}
      {showHistory && (
        <>
